        ...
        <div className="players">
          ...
          {this.state.users.map((user) => {
            ...
            return (
              <Link
                to={
                  user.id == this.props.profileData.id
                    ? "/myprofile"
                    : "/profile/" + user.id
                }
              >
                <div className="profile-block">
                  ...
                  {this.player && (
                    <p className="profile-name">
                      Игр:{this.player.games.length}
                    </p>
                  )}
                  {this.player && (
                    <p className="profile-name">Побед: {this.player.wins}</p>
                  )}
                  {this.player && (
                    <p className="profile-name">Очки:{this.player.points}</p>
                  )}
                  {this.player && (
                    <p className="profile-name">
                      Место в рейтинге:{this.player.rank}
                    </p>
                  )}
                </div>
              </Link>
